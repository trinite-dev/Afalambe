...
const defaultFooterColumns: LandingFooterColumn[] = [
    {
        heading: 'Product',
        links: [
...
export function LandingSiteFooter({
    ...
    const legalColumn = linkColumns[linkColumns.length - 1];
        ...
        >
            <div className="mx-auto max-w-[var(--lp-max-width)] px-6">
                <div className="grid grid-cols-2 gap-8 @sm:grid-cols-3">
                    ...
                    {linkColumns.slice(0, -1).map((column) => (
                        <div key={column.heading}>
                            <h3 className="mb-3 text-sm font-medium text-[var(--lp-fg)]">
                                {column.heading}
                            </h3>
                ...
                <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-[var(--lp-border)] pt-8">
                    <p className="text-sm text-[var(--lp-fg-muted)]">
                        &copy; {year} {holder}. {rightsReserved}
                    </p>
                    {legalColumn ? (
                        <nav className="flex flex-wrap gap-4" aria-label={legalNavAria}>
